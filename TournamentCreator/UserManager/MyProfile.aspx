<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="TournamentCreator.UserManager.MyProfile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
    <title>Tournament Creator :: Edit Profile</title>
			...
			<table style="width:100%" cellpadding=0 cellspacing=0>
                ...
                <td>
                   <form id="frmSignup" runat = "server">
                        ...
                        <td class="frmCont">
                            <asp:TextBox Enabled=false runat="server" ID="txtFirstName"></asp:TextBox><span class="caution">&nbsp;*</span>
                        ...
                        <td class="frmCont">
                            <asp:TextBox Enabled=false runat="server" ID="txtLastName"></asp:TextBox><span class="caution">&nbsp;*</span>
                        ...
                        <td class="frmCont">
                            <asp:TextBox Enabled=false runat="server" ID="txtEmailAddress"></asp:TextBox><span class="caution">&nbsp;*</span>
                        ...
                        <td class="frmCont">
                            <asp:TextBox runat="server" Text="********" ID="txtPassword" TextMode="Password"></asp:TextBox><span class="caution">&nbsp;*</span>
                        ...
                        <td class="frmCont">
                            <asp:TextBox runat="server" Text="********" ID="txtConfirmPassword" TextMode="Password"></asp:TextBox><span class="caution">&nbsp;*</span>
                        ...
                        <td></td>
                        <td class="frmCont">
                            <asp:Button Text="Sign Up" runat="server" id="btnUpdateProfile" onclick="btnUpdateProfile_Click"
                                 /></td>
                        </tr>
