<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="USubmitResult.aspx.cs" Inherits="TournamentCreator.TournamentManager.USubmitResult" %>
...
<body>
	...
	<div id="wrapper">
        ...
        <asp:Label ID="lblGameID" runat="server" Text="0" Visible="false"></asp:Label>
