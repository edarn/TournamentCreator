...
{
    public partial class UGameResult : System.Web.UI.Page
    {
        ...
        private bool initContents()
        {
            ...
            if(oUser.UserLevel != "user")
                Response.Redirect("../Notify.aspx?mc=10090020");

            oUserMgr.VerifyUResultRights(nRID, oUser.UserID);
            spOptions.InnerHtml = "<a href=\"USubmitResult.aspx?e=1&rid=\"" + strRID + ">Edit</a>";
            ...
            if(oGameMgr.IsResultSubmitedBy(nRID, oUser.UserID))
                spOptions.InnerHtml = "<a href=\"USubmitResult.aspx?e=1&rid=\"" + nRID.ToString() + ">Edit</a>";
            else
                Response.Redirect("../Notify.aspx?mc=10090020");
        ...
        public bool initContentsUser()
        {
            ...
            try
            {
                ...
                lblNavigation.Text = "&nbsp;&nbsp;&nbsp;";
                lblNavigation.Text += "<a href=\"../Default.aspx\">Home</a> > <a href=\"TournamentsList.aspx\"> Tournaments </a> > <a href=\"#\"> Unpublished Game Result</a> >";

                lblHeading.Text = "<h1>Tournament Creator</h1><h2>This result of the gamme is not published yet</h2>";
                contentsInit = true;
            }
            catch (Exception ex)
            {
